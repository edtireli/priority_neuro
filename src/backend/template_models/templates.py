BUILT_IN_TEMPLATES = {
    ...
    "poisson_rate": {
        ...
        "parameters": [
            {"name": "rate_control", "type": "float", "default_prior": {"dist": "Gamma", "shape": 2.0, "scale": 1.0}},
            {"name": "rate_experimental", "type": "float", "default_prior": {"dist": "Gamma", "shape": 2.0, "scale": 1.0}},
        ],
    },
}
